!function(t,i){
  "object"==typeof exports&&"undefined"!=typeof module? module.exports=i():"function"==typeof define&&define.amd? define(i):t.Trackball=i()
}(this,function(){
  "use strict";
  var t=1e-6,i="undefined"!=typeof Float32Array?Float32Array:Array;
  Math.PI;
  function e(){
    var t=new i(16);
  ...
  function n(i,e,n){
    var r,s,a,o=n[0],h=n[1],c=n[2],u=Math.sqrt(o*o+h*h+c*c);
    return u<t?null:(o*=u=1/u,h*=u,c*=u,r=Math.sin(e),a=1-(s=Math.cos(e)),i[0]=o*o*a+s,i[1]=h*o*a+c*r,i[2]=c*o*a-h*r,i[3]=0,i[4]=o*h*a-c*r,i[5]=h*h*a+s,i[6]=c*h*a+o*r,i[7]=0,i[8]=o*c*a+h*r,i[9]=h*c*a-o*r,i[10]=c*c*a+s,i[11]=0,i[12]=0,i[13]=0,i[14]=0,i[15]=1,i)
  }
  function r(){
    var t=new i(3);
